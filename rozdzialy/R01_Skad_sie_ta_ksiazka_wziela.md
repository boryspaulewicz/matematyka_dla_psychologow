...
matematyce pojęcia. Dobrymi przykładami poważnych błędów, wynikających z niezrozumienia
matematycznej nieuchronności kilku *prostych* zasad, są powszechne [wnioskowanie o braku efektu na
podstawie nieistotnego wyniku testu
...
(przytłaczająca większość psychologów wciąż nie zdaje sobie sprawy, jak poważne konsekwencje
wynikają z faktu, że [przyczynowość została
...
wyciągają z własnych i cudzych badań nieuzasadnione wnioski, popełniając przy tym często szkolne
błędy. Mimo to udaje im się publikować w wysokopunktowanych czasopismach, bo ich manuskrypty są
zwykle recenzowane i dopuszczane do druku przez innych matematycznych półanalfabetów. Rezultatem tej
zabawy w chowanego jest powszechna w psychologii już od dawna rozczarowująca [gra
...
podjąć próbę poznania od podstaw oszczędnego składniowo, pięknego i wyjątkowo ekspresyjnego języka
programowania.

Uprzedzam jednak, że ta książka *może zawierać błędy we fragmentach napisanych w języku naturalnym*,
czyli tam, gdzie mniej lub bardziej po swojemu objaśniam kod albo, co lubię robić, zapędzam się w
dygresje. To ryzyko nie wydaje mi się pomijalnie małe, bo jestem matematycznym amatorem. Co prawda
coś tam mogę pokazać jako "dowód", że trochę o matematyce wiem, ale nie ma tego wiele. Gdybyś więc
znalazła błąd, będę wdzięczny, jeśli mi o tym napiszesz, najlepiej na adres
boryspaulewicz@gmail.com, nie ten uczelniany.
...
wątpliwości, wystarczy tylko wkleić kod do Leana źeby się przekonać, czy wszystko się zgadza.
...
**cierpliwości i unikania frustracji** (albo, niemal równoważnie, upierania się przy tym, żeby nauka
była **przyjemna**).
...
którym zaszłaby jakościowa zmiana, odkrywamy jednak w końcu, że choć nie padał deszcz, jesteśmy
przemoczeni[^1].
...
definicją, twierdzeniem lub teorią może być dezorientacja, która z czasem niemal samoistnie ustępuje
wrażeniu, że wszystko jest w zasadzie oczywiste i proste. A właśnie, niedawno postanowiłem, że
...
ewentualny brak arogancji czy tupetu traci na znaczeniu, kiedy swoje tezy można *formalnie
...
można stale *dążyć*, ale czego *nie da się osiągnąć*. Dlatego też nigdy nic nie przestanie być
przynajmniej potencjalnie ciekawe[^4].
...
bliska czy analizować jak są zbudowane, jeśli akurat nie mają na to ochoty.
...
to jakoś wykorzystać, zacząłem uczyć się z cudownej książki Geuversa i Nederpelta [Type Theory and
Formal
...
polegającej często albo na czytaniu *po raz kolejny* tego samego *krótkiego* fragmentu, albo na
...
wolny i nierzadko frustrujący proces*.
...
chodzi tu o literówki czy inne tego rodzaju drobiazgi, tylko o błędy rzeczowe. Z niewielu rzeczy
jestem tak dumny jak z tego, dlatego często się tym chwalę. Nie wpadłbym na pomysł napisania czegoś
choćby tylko odlegle zbliżonego do tego tekstu, który masz właśnie przed oczami, gdyby nie ta
wspaniała książka i kontakt z tym niezwykłym człowiekiem. No więc z ambicjami lepiej nie przesadzać;
moim zdaniem, jak już wspominałem, o sukcesie w tego typu sprawach decydują przede wszystkim
*odpowiednie nastawienie* i *czas*.
