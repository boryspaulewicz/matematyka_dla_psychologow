...
żadnych zadań, za to jest coś, co myślę, że Ci się potem przyda. Wkrótce zaczniemy korzystać z
...
stanie się jasne, że to nic strasznego. Na początek powiem Ci coś o izomorfizmach w ogóle.
...
Jak być może wiesz, ten układ współrzędnych wprowadził do matematyki jeszcze w *XVII* wieku
francuski matematyk, filozof i fizyk [René
...
ani nie zniekształcamy żadnych własności problemu geometrycznego. Tego rodzaju sposoby *wiernego
...
pojawia się problem - całkiem możliwe, że *zbyt dobrze* przyzwyczaiłaś się do izomorfizmu opartego
na układzie współrzędnych kartezjańskich. Proszę Cię, żebyś teraz wyobraziła sobie płaszczyznę
całkiem nieliczbową, jeśli można tak powiedzieć. Taką płaszczyznę, którą mogłoby sobie wyobrazić
dziecko, które jeszcze nie poznało pojęcia liczby.

Jak wiesz, nie chodzi tu o żadną konkretną płaszczyznę *fizyczną*, tylko o coś w rodzaju idealnie
płaskiej powierzchni bez granic; takiej powierzchni, którą można sobie tylko wyobrazić i opisać, ale
która nie może istnieć jako obiekt fizyczny. Taką, o której chętnie myślą matematycy albo
filozofowie. Bez dodatkowych założeń, a właściwie raczej *wyborów pojęciowych*, ta płaszczyzna jako
taka *nie* ma charakteru liczbowego, tylko czysto geometryczny, albo czysto przestrzenny, jak
wolisz. Podobnie na przykład jakiś konkretny okrąg na tej płaszczyźnie *jako taki*, który moglibyśmy
sobie wyobrazić i który moglibyśmy próbować systematycznie opisać lub analizować, *nie* ma jeszcze
...
które mają *90* stopni, a o równości kątów jako o równości pewnych wielkości liczbowych, ale dla
Euklidesa to nie były liczby. Mógł pisać o *wielkościach* kątów, na przykład o tym, że jeden kąt
jest większy od drugiego, w takim samym znaczeniu, w jakim ktoś pozbawiony "ośrodka liczbowego" w
mózgu mógłby ocenić, które spodnie ma krótsze, a które ma dłuższe.
...
którą oznaczymy liczbą *1*, to dzięki tym *decyzjom* (a nie *założniom*) uzyskamy *układ
współrzędnych kartezjańskich*. 

Wystarczy nam ten jeden, definiujący jednostkę odległości punkt i od razu będziemy mieli
jednoznacznie wyznaczoną (bo "naturalnie" z niego wynikającą) "podziałkę" na obydwu osiach. Dzięki
połączeniu tych wszystkich elementów, to jest dwóch przecinających się osi i wynikającej z wybranej
jednostki odległości podziałki na obu, nasz układ współrzędnych działa jak doskonały tłumacz. Ten
tłumacz każdemu punktowi na każdej z osi (uwaga - nie mówimy jeszcze o punktach w dowolnym miejscu
na płaszczyźnie!) przyporządkowuje unikalną liczbę rzeczywistą, i odwrotnie, każdej liczbie
...
najpierw rozważając problemy o charakterze liczbowym, bo te obiekty są tak dziwne albo trudne do
wyobrażenia.
...
zagadnienia i pojęcia teorii wnioskowania przyczynowego za pomocą prostych symulacji, mając przy tym
pewność, że da się w ten sposób *wiernie*, to jest bez zniekształceń, *zrealizować* modele
...
psychologów może być łatwiejsze od rozwiązywania problemów rachunkowych.

Zwróć proszę uwagę, że chociaż prawie na pewno na początku to było dla Ciebie dosyć trudne, bo to
jest chyba dla wszystkich początkowo trudne, a już na pewno takie było początkowo dla mnie, to
...
ja teraz muszę przez kilka akapitów próbować Ci - i jednocześnie sobie! - ułatwić ich chwilowe
ponowne oddzielenie.

Czy to nie ciekawe, jak radykalnie taki z pozoru niewinny izomorfizm potrafi zmienić nasz sposób
...
korzystania* z tej swobody, byłyby nieosiągalne, gdyby nie było wystarczająco dobrej odpowiedniości
między dwoma, *dobrze określonymi rodzajami abstrakcyjnych struktur* i odpowiadającymi tym rodzajom
*sposobami opisu* albo *językami*.
...
żadnych informacji na temat złożonych procesów sterujących jej ruchami, a jednak wiesz, prawie na
pewno, że ta mysz *stara się gdzieś szybko dotrzeć, omijając Cię, ponieważ stoisz jej na
...
poruszającą się w bardzo regularny, natychmiast zrozumiały dla Ciebie sposób mysz tak jak patrzysz
na przykład na esencję herbaty rozpuszczającą się w gorącej wodzie? A jak myślisz, co by Ci mogło
umożliwić patrzenie w ten początkowo nienaturalny sposób na proces rozmowy, albo na przykład na
