...
Zacznijmy może od tego, że aby czas płynął, jak mówisz, wstecz, Ty musisz płynąć w czasie do przodu
i to jest relacja *logiczna*, a nie *przyczynowa*. A czemu nie można o tym myśleć jako o *spadaniu*
w czasie? Wtedy czas płynąłby w górę, a my w dół. Pamiętasz dualność relacji `<` i `>`?
