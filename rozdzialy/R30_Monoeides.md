...
Możemy teraz, korzystając z dostępnych w Leanie twierdzeń, *udowodnić, tworząc term typu `Monoid
Nat`*, że liczby naturalne są monoidem ze względu na dodawanie i `0`:
