...
tego, żebyś*my* tą konkretną książkę napisali *razem*. Bo to nie jest "moja" książka - zresztą żadna
książka nie jest tak naprawdę "czyjaś" - ani ona nie jest dla mnie. Zwłaszcza taka książka, która ma
*służyć do nauki*, nie powinna moim zdaniem (pozornie) "należeć" do żadnej konkretnej osoby, ani
...
niej skorzystać również badacze i teoretycy (chociaż psychologowie teoretyczni to rzadki gatunek)
zajmujący się psychologią naukową. To między innymi wprowadzenie, niemal
